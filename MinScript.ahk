...
^+space::	;-->		move to next clipboard, then paste
    {
        ...
        if (yCoord < 1 and xCoord <50 and clip_list.MaxIndex()>0) 
        {
...
Return
;-----------Emoji replace section--------------::;-->	This isn't working... maybe another time ¯\_(ツ)_/¯
...
Return
:*:!shrug::	;--> 		shrug is too hard to type
    {
        SendInput, ¯\_(ツ)_/¯
    }	
Return
;-----------Terminal Specific section--------------::;-->	Some things i typed too often in code

:*:!auth::	;--> 		vhb-dev-ops auth command
    {
        SendInput, vsts-npm-auth -config .npmrc
    }	
Return
...
Return
:*:!runpano::	;--> 		run pashare, don't use darth
    {
        SendInput, dotnet run -p C:\DEV\pa-share-web-api\pa-share-web-api --launch-profile ck
    }	
Return
:*:!runpayes::	;--> 		run pashare, use darth
    {
        SendInput, dotnet run -p C:\DEV\pa-share-web-api\pa-share-web-api --launch-profile ckUse
    }	
Return
:*:!runhino::	;--> 		run hicris, don't use darth
    {
        SendInput, dotnet run -p C:\DEV\hicris-web-api\hicris-web-api --launch-profile ck
    }	
Return
:*:!runhiyes::	;--> 		run hicris, use darth
    {
        SendInput, dotnet run -p C:\DEV\hicris-web-api\hicris-web-api --launch-profile ckuse
    }	
Return
